...
export const SwipeableCards: React.FC<SwipeableCardsProps> = ({
  ...
  return (
    <div className="relative w-full max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto h-[500px] sm:h-[600px] md:h-[700px] lg:h-[800px] xl:h-[85vh]">
      ...
      {/* Navigation buttons */}
      <div className="absolute bottom-4 lg:bottom-8 xl:bottom-12 left-1/2 transform -translate-x-1/2 flex gap-4 lg:gap-6 xl:gap-8 z-50">
        <button
          onClick={onPrevious}
